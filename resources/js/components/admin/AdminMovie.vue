                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th
                                    class="px-6 py-3 text-left">
                                    <div class="flex items-center">
                                        <button class="bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Public</button>
                                    </div>
                                </th>
                                <th
                                    class="px-6 py-3 text-left">
                                    <div class="flex items-center">
                                        <button class="bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Visits</button>
                                    </div>
                                </th>
                            ...
                            <tr v-for="movie in movies" :key="movie.id" >
                                ...
                                <td class="w-4/12 px-6 py-4 whitespace-no-wrap">
                                    <div class="text-sm leading-5 text-gray-900">{{ movie.is_public}}</div>
                                </td>
                                <td class="w-4/12 px-6 py-4 whitespace-no-wrap">
                                    <div class="text-sm leading-5 text-gray-900">{{ movie.visits}}</div>
                                </td>
...
export default {
    ...
    methods: {
        ...
        getGenres() {
            const _this = this;
            const baseUrl = `/api/admin/admin-movie-genres`;
            axios
                .get(baseUrl)
                .then((res) => {
        ...
        getTags() {
            const _this = this;
            const baseUrl = `/api/admin/admin-movie-tags`;
            axios
                .get(baseUrl)
                .then((res) => {
