...
Route::group([
    ...
    Route::get('/admin-movie-tags', [ApiAdminTagController::class, 'movie_tags']);
    Route::apiResource('/admin-casts', ApiAdminCastController::class);
    Route::get('/admin-movie-casts', [ApiAdminCastController::class, 'movie_casts']);
    Route::apiResource('/admin-genres', ApiAdminGenreController::class);
    Route::get('/admin-movie-genres', [ApiAdminGenreController::class, 'movie_genres']);
